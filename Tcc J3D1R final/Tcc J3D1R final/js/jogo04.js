...
next.addEventListener('click', verificaCodigo);
 ...
 function verificaCodigo(e) {
    ...
    if (valor === 'justify-content: space-between;' || valor === 'justify-content:space-between;' || valor === ' justify-content:space-between;' || valor === ' justify-content: space-between;' 
        || valor === 'justify-content: space-between; ' || valor === ' justify-content: space-between; ') {
        /* alert('YUHUUUL!'); */
        actionHTML.style.justifyContent = 'space-between';
